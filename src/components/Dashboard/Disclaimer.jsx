  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      <div className="max-w-2xl p-6 mb-4 bg-white shadow-md rounded-md">
        <h1 className="text-2xl font-semibold mb-4 text-center italic">
          Disclaimer
        </h1>
        <p className="text-gray-700 mb-4">
          Media pembelajaran ini disusun oleh The Lungs Tech sebagai bagian dari
          proyek pembelajaran. Materi dan informasi yang terdapat dalam media
          ini disusun dengan seksama berdasarkan penelitian dan referensi yang
          relevan pada saat penyusunan.
        </p>
        <p className="text-gray-700 mb-4">
